...
SELECT a.first_name, a.last_name, a.employee_id, b.start_date, b.end_date, a.job_id, a.department_id
...
SELECT CONCAT(a.first_name,"-",a.last_name) 직원이름 , d.job_title 부서이름, c.state_province 소재지
  FROM employees a, departments b, locations c, job d
